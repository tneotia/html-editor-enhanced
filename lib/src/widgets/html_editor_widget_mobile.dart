...
class _HtmlEditorWidgetMobileState extends State<HtmlEditorWidget> {
  ...
  final insertSelected = List<bool>.filled(5, false);
                ...
                child: InAppWebView(
                  ...
                  onWebViewCreated: (InAppWebViewController controller) {
                    ...
                    controller.addJavaScriptHandler(handlerName: 'FormatSettings', callback: (e) {
                      ...
                      double fontSize = double.tryParse(json['fontSize']) ?? 16;
                  ...
                  onWindowFocus: (controller) async {
                    ...
                    if (widget.options.adjustHeightForKeyboard) {
                      ...
                      await controller.evaluateJavascript(
                          source:
                          "\$('div.note-editable').height(${max(docHeight - 10, 30)});");
                    }
                  },
                  onLoadStop:
                        ...
                        controller.addJavaScriptHandler(
                            ...
                            callback: (height) {
                              if (height.first == "reset") {
                                ...
                                docHeight =
                                    double.tryParse(height.first.toString()) ?? widget.options.height;
                              }
                            });
