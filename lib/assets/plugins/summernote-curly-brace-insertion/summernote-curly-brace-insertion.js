    ...
    summernoteCurlyBraceInsertion: function(context) {
      ...
      this.events = {
        ...
        "summernote.keyup": async (_, event) => {
          ...
          console.error("word = " + word + ", anchorOffset");
          console.error("selection = " + selection + ", currentText = " + currentText);
          ...
          console.error("word[0] = " + word[0] + ", word[1] = " + word[1]);
          if (
      ...
      this.handleSelection = () => {
        ...
        console.error("currentText(blah) = " + currentText);
        selection.anchorNode.textContent =
          currentText.slice(0, absoluteIndex + 3) +
          newWord +
          " " +
          currentText.slice(absoluteIndex + word.length);

        selectionPreserver.restore(absoluteIndex + newWord.length + 3);
      ...
      this.setAutocompleteAnchor = (atTextIndex, indexAnchor) => {
        ...
        indexAnchor.parentNode.innerHTML =
          html.slice(0, htmlIndex) + spanString + html.slice(htmlIndex + 3);
