  ...
  $.extend($.summernote.plugins, {
    summernoteAtMention: function summernoteAtMention(context) {
      ...
      this.events = {
        ...
        "summernote.keyup": async function summernoteKeyup(_, event) {
